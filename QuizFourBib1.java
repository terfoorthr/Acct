    ...
    public int startQuiz(){
        ...
        for (Question quizM : questions1){
            ...
            if (group.getSelection().getActionCommand().equals(quizM.getCorrectAnswer())){
            	 ...
            	 JOptionPane.showMessageDialog(null,"Das ist Richtig","Glückwunsch",JOptionPane.INFORMATION_MESSAGE); 
            	
                score++;
                
            }else if (group.getSelection().getActionCommand().equals(null))
            {
            	JOptionPane.showMessageDialog(null, "", "Bitte Antwort wählen", JOptionPane.ERROR_MESSAGE);	
            	
            }
            
            else JOptionPane.showMessageDialog(null, quizM.getCorrectAnswer(), "Die richtige Antwort währe...", JOptionPane.ERROR_MESSAGE);
